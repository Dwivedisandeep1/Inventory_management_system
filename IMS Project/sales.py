...
class salesClass:
    def __init__(self,root):
       ...
       btn_search=Button(self.root,text="open",command=self.search,font=("times new roman",15,"bold"),bg="#2196f3",fg="white",cursor="hand2").place(x=360,y=100,width=120,height=28)
       btn_clear=Button(self.root,text="clear",command=self.clear,font=("times new roman",15,"bold"),bg="lightgrey",fg="black",cursor="hand2").place(x=520,y=100,width=120,height=28)
...
#bill Area
       ...
       lbl_title2=Label(bill_Frame,text="Customer Bill Area",font=("goudy old style",20),bg="orange",fg="black",).pack(side=TOP,fill=X)
