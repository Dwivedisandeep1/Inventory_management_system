...
class employeeClass:
    def __init__(self,root):
       ...
       lbl_dob=Label(self.root,text="D.O.B \n DD\MM\YYYY",font=("goudy old style",10),bg="white").place(x=350,y=190)
       lbl_doj=Label(self.root,text="D.O.J\n DD\MM\YYYY",font=("goudy old style",10),bg="white").place(x=750,y=190)
